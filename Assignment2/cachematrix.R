## Assignment 2: Caching the Inverse af a Matrix
## Matrix inversion is usually a costly computation and there may be some 
## benefit to caching the inverse of a matrix rather than computing it 
## repeatedly. The following code contains two functions for Caching the
## inverse of a matrix and caluculation the inverse of a matirx.
